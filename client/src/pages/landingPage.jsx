        ...
        <div className="w-9/10 container mx-auto px-4 pt-6 pb-[200px] relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <button
                className="bg-[#670D2F] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-[#FFEEF4] hover:text-black border border-[#F7CFD8] hover:border-[#670D2F] transition-colors cursor-pointer"
                onClick={handleCTA}
              >
                Get Started
              </button>
